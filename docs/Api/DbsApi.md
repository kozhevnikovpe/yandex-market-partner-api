...
| ------------- | ------------- | ------------- |
| [**acceptOrderCancellation_0()**](DbsApi.md#acceptOrderCancellation_0) | **PUT** /campaigns/{campaignId}/orders/{orderId}/cancellation/accept | Отмена заказа покупателем |
| [**addHiddenOffers_2()**](DbsApi.md#addHiddenOffers_2) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия |
| [**addOffersToArchive_0()**](DbsApi.md#addOffersToArchive_0) | **POST** /businesses/{businessId}/offer-mappings/archive | Добавление товаров в архив |
| [**calculateTariffs_2()**](DbsApi.md#calculateTariffs_2) | **POST** /tariffs/calculate | Калькулятор стоимости услуг |
| [**confirmBusinessPrices_0()**](DbsApi.md#confirmBusinessPrices_0) | **POST** /businesses/{businessId}/price-quarantine/confirm | Удаление товара из карантина по цене в кабинете |
| [**confirmCampaignPrices_0()**](DbsApi.md#confirmCampaignPrices_0) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Удаление товара из карантина по цене в магазине |
| [**createChat_0()**](DbsApi.md#createChat_0) | **POST** /businesses/{businessId}/chats/new | Создание нового чата с покупателем |
| [**createOutlet_0()**](DbsApi.md#createOutlet_0) | **POST** /campaigns/{campaignId}/outlets | Создание точки продаж |
| [**deleteCampaignOffers_0()**](DbsApi.md#deleteCampaignOffers_0) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина |
| [**deleteGoodsFeedbackComment_2()**](DbsApi.md#deleteGoodsFeedbackComment_2) | **POST** /businesses/{businessId}/goods-feedback/comments/delete | Удаление комментария к отзыву |
| [**deleteHiddenOffers_2()**](DbsApi.md#deleteHiddenOffers_2) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров |
| [**deleteOffersFromArchive_0()**](DbsApi.md#deleteOffersFromArchive_0) | **POST** /businesses/{businessId}/offer-mappings/unarchive | Удаление товаров из архива |
| [**deleteOffers_0()**](DbsApi.md#deleteOffers_0) | **POST** /businesses/{businessId}/offer-mappings/delete | Удаление товаров из каталога |
| [**deleteOutletLicenses_0()**](DbsApi.md#deleteOutletLicenses_0) | **DELETE** /campaigns/{campaignId}/outlets/licenses | Удаление лицензий для точек продаж |
| [**deleteOutlet_0()**](DbsApi.md#deleteOutlet_0) | **DELETE** /campaigns/{campaignId}/outlets/{outletId} | Удаление точки продаж |
| [**deletePromoOffers_2()**](DbsApi.md#deletePromoOffers_2) | **POST** /businesses/{businessId}/promos/offers/delete | Удаление товаров из акции |
| [**generateBoostConsolidatedReport_2()**](DbsApi.md#generateBoostConsolidatedReport_2) | **POST** /reports/boost-consolidated/generate | Отчет по бусту продаж |
| [**generateCompetitorsPositionReport_1()**](DbsApi.md#generateCompetitorsPositionReport_1) | **POST** /reports/competitors-position/generate | Отчет «Конкурентная позиция» |
| [**generateGoodsFeedbackReport_2()**](DbsApi.md#generateGoodsFeedbackReport_2) | **POST** /reports/goods-feedback/generate | Отчет по отзывам о товарах |
| [**generateMassOrderLabelsReport_1()**](DbsApi.md#generateMassOrderLabelsReport_1) | **POST** /reports/documents/labels/generate | Готовые ярлыки‑наклейки на все коробки в нескольких заказах |
| [**generateOrderLabel_1()**](DbsApi.md#generateOrderLabel_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label | Готовый ярлык‑наклейка для коробки в заказе |
| [**generateOrderLabels_1()**](DbsApi.md#generateOrderLabels_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels | Готовые ярлыки‑наклейки на все коробки в одном заказе |
| [**generatePricesReport_2()**](DbsApi.md#generatePricesReport_2) | **POST** /reports/prices/generate | Отчет «Цены на рынке» |
| [**generateShelfsStatisticsReport_2()**](DbsApi.md#generateShelfsStatisticsReport_2) | **POST** /reports/shelf-statistics/generate | Отчет по полкам |
| [**generateShowsSalesReport_1()**](DbsApi.md#generateShowsSalesReport_1) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж» |
| [**generateStocksOnWarehousesReport_2()**](DbsApi.md#generateStocksOnWarehousesReport_2) | **POST** /reports/stocks-on-warehouses/generate | Отчет по остаткам на складах |
| [**generateUnitedMarketplaceServicesReport_1()**](DbsApi.md#generateUnitedMarketplaceServicesReport_1) | **POST** /reports/united-marketplace-services/generate | Отчет по стоимости услуг |
| [**generateUnitedNettingReport_1()**](DbsApi.md#generateUnitedNettingReport_1) | **POST** /reports/united-netting/generate | Отчет по платежам |
| [**generateUnitedOrdersReport_2()**](DbsApi.md#generateUnitedOrdersReport_2) | **POST** /reports/united-orders/generate | Отчет по заказам |
| [**getAllOffers_0()**](DbsApi.md#getAllOffers_0) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина |
| [**getBidsInfoForBusiness_0()**](DbsApi.md#getBidsInfoForBusiness_0) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках |
| [**getBidsRecommendations_0()**](DbsApi.md#getBidsRecommendations_0) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров |
| [**getBusinessQuarantineOffers_0()**](DbsApi.md#getBusinessQuarantineOffers_0) | **POST** /businesses/{businessId}/price-quarantine | Список товаров, находящихся в карантине по цене в кабинете |
| [**getBusinessSettings_0()**](DbsApi.md#getBusinessSettings_0) | **POST** /businesses/{businessId}/settings | Настройки кабинета |
| [**getCampaignLogins_0()**](DbsApi.md#getCampaignLogins_0) | **GET** /campaigns/{campaignId}/logins | Логины, связанные с магазином |
| [**getCampaignOffers_0()**](DbsApi.md#getCampaignOffers_0) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине |
| [**getCampaignQuarantineOffers_0()**](DbsApi.md#getCampaignQuarantineOffers_0) | **POST** /campaigns/{campaignId}/price-quarantine | Список товаров, находящихся в карантине по цене в магазине |
| [**getCampaignRegion_0()**](DbsApi.md#getCampaignRegion_0) | **GET** /campaigns/{campaignId}/region | Регион магазина |
| [**getCampaignSettings_0()**](DbsApi.md#getCampaignSettings_0) | **GET** /campaigns/{campaignId}/settings | Настройки магазина |
| [**getCampaign_0()**](DbsApi.md#getCampaign_0) | **GET** /campaigns/{campaignId} | Информация о магазине |
| [**getCampaignsByLogin_0()**](DbsApi.md#getCampaignsByLogin_0) | **GET** /campaigns/by_login/{login} | Магазины, доступные логину |
| [**getCampaigns_0()**](DbsApi.md#getCampaigns_0) | **GET** /campaigns | Список магазинов пользователя |
| [**getCategoriesMaxSaleQuantum_2()**](DbsApi.md#getCategoriesMaxSaleQuantum_2) | **POST** /categories/max-sale-quantum | Лимит на установку кванта продажи и минимального количества товаров в заказе |
| [**getCategoriesTree_2()**](DbsApi.md#getCategoriesTree_2) | **POST** /categories/tree | Дерево категорий |
| [**getCategoryContentParameters_0()**](DbsApi.md#getCategoryContentParameters_0) | **POST** /category/{categoryId}/parameters | Списки характеристик товаров по категориям |
| [**getChatHistory_0()**](DbsApi.md#getChatHistory_0) | **POST** /businesses/{businessId}/chats/history | Получение истории сообщений в чате |
| [**getChats_0()**](DbsApi.md#getChats_0) | **POST** /businesses/{businessId}/chats | Получение доступных чатов |
| [**getDeliveryServices_1()**](DbsApi.md#getDeliveryServices_1) | **GET** /delivery/services | Справочник служб доставки |
| [**getFeedIndexLogs_0()**](DbsApi.md#getFeedIndexLogs_0) | **GET** /campaigns/{campaignId}/feeds/{feedId}/index-logs | Отчет по индексации прайс-листа |
| [**getFeed_0()**](DbsApi.md#getFeed_0) | **GET** /campaigns/{campaignId}/feeds/{feedId} | Информация о прайс-листе |
| [**getFeedbackAndCommentUpdates_0()**](DbsApi.md#getFeedbackAndCommentUpdates_0) | **GET** /campaigns/{campaignId}/feedback/updates | Новые и обновленные отзывы о магазине |
| [**getFeeds_0()**](DbsApi.md#getFeeds_0) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина |
| [**getGoodsFeedbackComments_2()**](DbsApi.md#getGoodsFeedbackComments_2) | **POST** /businesses/{businessId}/goods-feedback/comments | Получение комментариев к отзыву |
| [**getGoodsFeedbacks_2()**](DbsApi.md#getGoodsFeedbacks_2) | **POST** /businesses/{businessId}/goods-feedback | Получение отзывов о товарах продавца |
| [**getGoodsStats_3()**](DbsApi.md#getGoodsStats_3) | **POST** /campaigns/{campaignId}/stats/skus | Отчет по товарам |
| [**getHiddenOffers_2()**](DbsApi.md#getHiddenOffers_2) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах |
| [**getModelOffers_0()**](DbsApi.md#getModelOffers_0) | **GET** /models/{modelId}/offers | Список предложений для одной модели |
| [**getModel_0()**](DbsApi.md#getModel_0) | **GET** /models/{modelId} | Информация об одной модели |
| [**getModelsOffers_0()**](DbsApi.md#getModelsOffers_0) | **POST** /models/offers | Список предложений для нескольких моделей |
| [**getModels_0()**](DbsApi.md#getModels_0) | **POST** /models | Информация о нескольких моделях |
| [**getOfferCardsContentStatus_0()**](DbsApi.md#getOfferCardsContentStatus_0) | **POST** /businesses/{businessId}/offer-cards | Получение информации о заполненности карточек магазина |
| [**getOfferMappingEntries_3()**](DbsApi.md#getOfferMappingEntries_3) | **GET** /campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге |
| [**getOfferMappings_0()**](DbsApi.md#getOfferMappings_0) | **POST** /businesses/{businessId}/offer-mappings | Информация о товарах в каталоге |
| [**getOfferRecommendations_0()**](DbsApi.md#getOfferRecommendations_0) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен |
| [**getOffers_0()**](DbsApi.md#getOffers_0) | **GET** /campaigns/{campaignId}/offers | Предложения магазина |
| [**getOrderBusinessBuyerInfo_2()**](DbsApi.md#getOrderBusinessBuyerInfo_2) | **POST** /campaigns/{campaignId}/orders/{orderId}/business-buyer | Информация о покупателе — юридическом лице |
| [**getOrderBusinessDocumentsInfo_2()**](DbsApi.md#getOrderBusinessDocumentsInfo_2) | **POST** /campaigns/{campaignId}/orders/{orderId}/documents | Информация о документах |
| [**getOrderBuyerInfo_0()**](DbsApi.md#getOrderBuyerInfo_0) | **GET** /campaigns/{campaignId}/orders/{orderId}/buyer | Информация о покупателе — физическом лице |
| [**getOrderLabelsData_1()**](DbsApi.md#getOrderLabelsData_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data | Данные для самостоятельного изготовления ярлыков |
| [**getOrder_2()**](DbsApi.md#getOrder_2) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе |
| [**getOrdersStats_2()**](DbsApi.md#getOrdersStats_2) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам |
| [**getOrders_1()**](DbsApi.md#getOrders_1) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах |
| [**getOutletLicenses_0()**](DbsApi.md#getOutletLicenses_0) | **GET** /campaigns/{campaignId}/outlets/licenses | Информация о лицензиях для точек продаж |
| [**getOutlet_0()**](DbsApi.md#getOutlet_0) | **GET** /campaigns/{campaignId}/outlets/{outletId} | Информация об одной точке продаж |
| [**getOutlets_0()**](DbsApi.md#getOutlets_0) | **GET** /campaigns/{campaignId}/outlets | Информация о нескольких точках продаж |
| [**getPricesByOfferIds_2()**](DbsApi.md#getPricesByOfferIds_2) | **POST** /campaigns/{campaignId}/offer-prices | Просмотр цен на указанные товары в магазине |
| [**getPrices_2()**](DbsApi.md#getPrices_2) | **GET** /campaigns/{campaignId}/offer-prices | Список цен |
| [**getPromoOffers_2()**](DbsApi.md#getPromoOffers_2) | **POST** /businesses/{businessId}/promos/offers | Получение списка товаров, которые участвуют или могут участвовать в акции |
| [**getPromos_2()**](DbsApi.md#getPromos_2) | **POST** /businesses/{businessId}/promos | Получение списка акций |
| [**getQualityRatingDetails_1()**](DbsApi.md#getQualityRatingDetails_1) | **POST** /campaigns/{campaignId}/ratings/quality/details | Заказы, которые повлияли на индекс качества |
| [**getQualityRatings_2()**](DbsApi.md#getQualityRatings_2) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов |
| [**getReportInfo_1()**](DbsApi.md#getReportInfo_1) | **GET** /reports/info/{reportId} | Получение заданного отчета |
| [**getReturnApplication_1()**](DbsApi.md#getReturnApplication_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application | Получение заявления на возврат |
| [**getReturnPhoto_1()**](DbsApi.md#getReturnPhoto_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash} | Получение фотографии возврата |
| [**getReturn_1()**](DbsApi.md#getReturn_1) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о невыкупе или возврате |
| [**getReturns_1()**](DbsApi.md#getReturns_1) | **GET** /campaigns/{campaignId}/returns | Список невыкупов и возвратов |
| [**getStocks_2()**](DbsApi.md#getStocks_2) | **POST** /campaigns/{campaignId}/offers/stocks | Информация об остатках и оборачиваемости |
| [**getSuggestedOfferMappingEntries_3()**](DbsApi.md#getSuggestedOfferMappingEntries_3) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров |
| [**getSuggestedOfferMappings_0()**](DbsApi.md#getSuggestedOfferMappings_0) | **POST** /businesses/{businessId}/offer-mappings/suggestions | Просмотр карточек на Маркете, которые подходят вашим товарам |
| [**getSuggestedPrices_3()**](DbsApi.md#getSuggestedPrices_3) | **POST** /campaigns/{campaignId}/offer-prices/suggestions | Цены для продвижения товаров |
| [**getWarehouses_1()**](DbsApi.md#getWarehouses_1) | **GET** /businesses/{businessId}/warehouses | Список складов и групп складов |
| [**provideOrderDigitalCodes_0()**](DbsApi.md#provideOrderDigitalCodes_0) | **POST** /campaigns/{campaignId}/orders/{orderId}/deliverDigitalGoods | Передача ключей цифровых товаров |
| [**provideOrderItemIdentifiers_1()**](DbsApi.md#provideOrderItemIdentifiers_1) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача кодов маркировки единиц товара |
| [**putBidsForBusiness_0()**](DbsApi.md#putBidsForBusiness_0) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок |
| [**putBidsForCampaign_0()**](DbsApi.md#putBidsForCampaign_0) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина |
| [**refreshFeed_0()**](DbsApi.md#refreshFeed_0) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился |
| [**searchModels_0()**](DbsApi.md#searchModels_0) | **GET** /models | Поиск модели товара |
| [**searchRegionChildren_2()**](DbsApi.md#searchRegionChildren_2) | **GET** /regions/{regionId}/children | Информация о дочерних регионах |
| [**searchRegionsById_2()**](DbsApi.md#searchRegionsById_2) | **GET** /regions/{regionId} | Информация о регионе |
| [**searchRegionsByName_2()**](DbsApi.md#searchRegionsByName_2) | **GET** /regions | Поиск регионов по их имени |
| [**sendFileToChat_0()**](DbsApi.md#sendFileToChat_0) | **POST** /businesses/{businessId}/chats/file/send | Отправка файла в чат |
| [**sendMessageToChat_0()**](DbsApi.md#sendMessageToChat_0) | **POST** /businesses/{businessId}/chats/message | Отправка сообщения в чат |
| [**setFeedParams_0()**](DbsApi.md#setFeedParams_0) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа |
| [**setOrderBoxLayout_2()**](DbsApi.md#setOrderBoxLayout_2) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа |
| [**setOrderDeliveryDate_0()**](DbsApi.md#setOrderDeliveryDate_0) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/date | Изменение даты доставки заказа |
| [**setOrderDeliveryTrackCode_0()**](DbsApi.md#setOrderDeliveryTrackCode_0) | **POST** /campaigns/{campaignId}/orders/{orderId}/delivery/track | Передача трек‑номера посылки |
| [**setOrderShipmentBoxes_1()**](DbsApi.md#setOrderShipmentBoxes_1) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes | Передача количества грузовых мест в заказе |
| [**setReturnDecision_0()**](DbsApi.md#setReturnDecision_0) | **POST** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision | Принятие или изменение решения по возврату |
| [**skipGoodsFeedbacksReaction_2()**](DbsApi.md#skipGoodsFeedbacksReaction_2) | **POST** /businesses/{businessId}/goods-feedback/skip-reaction | Отказ от ответа на отзывы |
| [**submitReturnDecision_0()**](DbsApi.md#submitReturnDecision_0) | **POST** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/submit | Подтверждение решения по возврату |
| [**updateBusinessPrices_2()**](DbsApi.md#updateBusinessPrices_2) | **POST** /businesses/{businessId}/offer-prices/updates | Установка цен на товары во всех магазинах |
| [**updateCampaignOffers_0()**](DbsApi.md#updateCampaignOffers_0) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине |
| [**updateGoodsFeedbackComment_2()**](DbsApi.md#updateGoodsFeedbackComment_2) | **POST** /businesses/{businessId}/goods-feedback/comments/update | Добавление нового или изменение созданного комментария |
| [**updateOfferContent_0()**](DbsApi.md#updateOfferContent_0) | **POST** /businesses/{businessId}/offer-cards/update | Редактирование категорийных характеристик товара |
| [**updateOfferMappingEntries_3()**](DbsApi.md#updateOfferMappingEntries_3) | **POST** /campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге |
| [**updateOfferMappings_0()**](DbsApi.md#updateOfferMappings_0) | **POST** /businesses/{businessId}/offer-mappings/update | Добавление товаров в каталог и изменение информации о них |
| [**updateOrderItems_1()**](DbsApi.md#updateOrderItems_1) | **PUT** /campaigns/{campaignId}/orders/{orderId}/items | Удаление товара из заказа или уменьшение числа единиц |
| [**updateOrderStatus_1()**](DbsApi.md#updateOrderStatus_1) | **PUT** /campaigns/{campaignId}/orders/{orderId}/status | Изменение статуса одного заказа |
| [**updateOrderStatuses_1()**](DbsApi.md#updateOrderStatuses_1) | **POST** /campaigns/{campaignId}/orders/status-update | Изменение статусов нескольких заказов |
| [**updateOrderStorageLimit_0()**](DbsApi.md#updateOrderStorageLimit_0) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/storage-limit | Продление срока хранения заказа |
| [**updateOutletLicenses_0()**](DbsApi.md#updateOutletLicenses_0) | **POST** /campaigns/{campaignId}/outlets/licenses | Создание и изменение лицензий для точек продаж |
| [**updateOutlet_0()**](DbsApi.md#updateOutlet_0) | **PUT** /campaigns/{campaignId}/outlets/{outletId} | Изменение информации о точке продаж |
| [**updatePrices_2()**](DbsApi.md#updatePrices_2) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары в конкретном магазине |
| [**updatePromoOffers_2()**](DbsApi.md#updatePromoOffers_2) | **POST** /businesses/{businessId}/promos/offers/update | Добавление товаров в акцию или изменение их цен |
| [**updateStocks_1()**](DbsApi.md#updateStocks_1) | **PUT** /campaigns/{campaignId}/offers/stocks | Передача информации об остатках |


## `acceptOrderCancellation_0()`

```php
acceptOrderCancellation_0($campaign_id, $order_id, $accept_order_cancellation_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->acceptOrderCancellation_0($campaign_id, $order_id, $accept_order_cancellation_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->acceptOrderCancellation_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
addHiddenOffers_2($campaign_id, $add_hidden_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->addHiddenOffers_2($campaign_id, $add_hidden_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->addHiddenOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
addOffersToArchive_0($business_id, $add_offers_to_archive_request): \OpenAPI\Client\Model\AddOffersToArchiveResponse
```
...
try {
    $result = $apiInstance->addOffersToArchive_0($business_id, $add_offers_to_archive_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->addOffersToArchive_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
calculateTariffs_2($calculate_tariffs_request): \OpenAPI\Client\Model\CalculateTariffsResponse
```
...
try {
    $result = $apiInstance->calculateTariffs_2($calculate_tariffs_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->calculateTariffs_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
confirmBusinessPrices_0($business_id, $confirm_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->confirmBusinessPrices_0($business_id, $confirm_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->confirmBusinessPrices_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
confirmCampaignPrices_0($campaign_id, $confirm_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->confirmCampaignPrices_0($campaign_id, $confirm_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->confirmCampaignPrices_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createChat_0($business_id, $create_chat_request): \OpenAPI\Client\Model\CreateChatResponse
```
...
try {
    $result = $apiInstance->createChat_0($business_id, $create_chat_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->createChat_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createOutlet_0($campaign_id, $change_outlet_request): \OpenAPI\Client\Model\CreateOutletResponse
```
...
try {
    $result = $apiInstance->createOutlet_0($campaign_id, $change_outlet_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->createOutlet_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteCampaignOffers_0($campaign_id, $delete_campaign_offers_request): \OpenAPI\Client\Model\DeleteCampaignOffersResponse
```
...
try {
    $result = $apiInstance->deleteCampaignOffers_0($campaign_id, $delete_campaign_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteCampaignOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteGoodsFeedbackComment_2($business_id, $delete_goods_feedback_comment_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteGoodsFeedbackComment_2($business_id, $delete_goods_feedback_comment_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteGoodsFeedbackComment_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteHiddenOffers_2($campaign_id, $delete_hidden_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteHiddenOffers_2($campaign_id, $delete_hidden_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteHiddenOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOffersFromArchive_0($business_id, $delete_offers_from_archive_request): \OpenAPI\Client\Model\DeleteOffersFromArchiveResponse
```
...
try {
    $result = $apiInstance->deleteOffersFromArchive_0($business_id, $delete_offers_from_archive_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteOffersFromArchive_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOffers_0($business_id, $delete_offers_request): \OpenAPI\Client\Model\DeleteOffersResponse
```
...
try {
    $result = $apiInstance->deleteOffers_0($business_id, $delete_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOutletLicenses_0($campaign_id, $ids): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteOutletLicenses_0($campaign_id, $ids);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteOutletLicenses_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOutlet_0($campaign_id, $outlet_id): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteOutlet_0($campaign_id, $outlet_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deleteOutlet_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deletePromoOffers_2($business_id, $delete_promo_offers_request): \OpenAPI\Client\Model\DeletePromoOffersResponse
```
...
try {
    $result = $apiInstance->deletePromoOffers_2($business_id, $delete_promo_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->deletePromoOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateBoostConsolidatedReport_2($generate_boost_consolidated_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateBoostConsolidatedReport_2($generate_boost_consolidated_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateBoostConsolidatedReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateCompetitorsPositionReport_1($generate_competitors_position_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateCompetitorsPositionReport_1($generate_competitors_position_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateCompetitorsPositionReport_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateGoodsFeedbackReport_2($generate_goods_feedback_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateGoodsFeedbackReport_2($generate_goods_feedback_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateGoodsFeedbackReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateMassOrderLabelsReport_1($generate_mass_order_labels_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateMassOrderLabelsReport_1($generate_mass_order_labels_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateMassOrderLabelsReport_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateOrderLabel_1($campaign_id, $order_id, $shipment_id, $box_id, $format): \SplFileObject
```
...
try {
    $result = $apiInstance->generateOrderLabel_1($campaign_id, $order_id, $shipment_id, $box_id, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateOrderLabel_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateOrderLabels_1($campaign_id, $order_id, $format): \SplFileObject
```
...
try {
    $result = $apiInstance->generateOrderLabels_1($campaign_id, $order_id, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateOrderLabels_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generatePricesReport_2($generate_prices_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generatePricesReport_2($generate_prices_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generatePricesReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateShelfsStatisticsReport_2($generate_shelfs_statistics_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateShelfsStatisticsReport_2($generate_shelfs_statistics_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateShelfsStatisticsReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateShowsSalesReport_1($generate_shows_sales_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateShowsSalesReport_1($generate_shows_sales_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateShowsSalesReport_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateStocksOnWarehousesReport_2($generate_stocks_on_warehouses_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateStocksOnWarehousesReport_2($generate_stocks_on_warehouses_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateStocksOnWarehousesReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateUnitedMarketplaceServicesReport_1($generate_united_marketplace_services_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedMarketplaceServicesReport_1($generate_united_marketplace_services_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateUnitedMarketplaceServicesReport_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateUnitedNettingReport_1($generate_united_netting_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedNettingReport_1($generate_united_netting_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateUnitedNettingReport_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
generateUnitedOrdersReport_2($generate_united_orders_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedOrdersReport_2($generate_united_orders_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->generateUnitedOrdersReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAllOffers_0($campaign_id, $feed_id, $chunk): \OpenAPI\Client\Model\GetAllOffersResponse
```
...
try {
    $result = $apiInstance->getAllOffers_0($campaign_id, $feed_id, $chunk);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getAllOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBidsInfoForBusiness_0($business_id, $page_token, $limit, $get_bids_info_request): \OpenAPI\Client\Model\GetBidsInfoResponse
```
...
try {
    $result = $apiInstance->getBidsInfoForBusiness_0($business_id, $page_token, $limit, $get_bids_info_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getBidsInfoForBusiness_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBidsRecommendations_0($business_id, $get_bids_recommendations_request): \OpenAPI\Client\Model\GetBidsRecommendationsResponse
```
...
try {
    $result = $apiInstance->getBidsRecommendations_0($business_id, $get_bids_recommendations_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getBidsRecommendations_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBusinessQuarantineOffers_0($business_id, $get_quarantine_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetQuarantineOffersResponse
```
...
try {
    $result = $apiInstance->getBusinessQuarantineOffers_0($business_id, $get_quarantine_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getBusinessQuarantineOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBusinessSettings_0($business_id): \OpenAPI\Client\Model\GetBusinessSettingsResponse
```
...
try {
    $result = $apiInstance->getBusinessSettings_0($business_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getBusinessSettings_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignLogins_0($campaign_id): \OpenAPI\Client\Model\GetCampaignLoginsResponse
```
...
try {
    $result = $apiInstance->getCampaignLogins_0($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignLogins_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignOffers_0($campaign_id, $get_campaign_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetCampaignOffersResponse
```
...
try {
    $result = $apiInstance->getCampaignOffers_0($campaign_id, $get_campaign_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignQuarantineOffers_0($campaign_id, $get_quarantine_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetQuarantineOffersResponse
```
...
try {
    $result = $apiInstance->getCampaignQuarantineOffers_0($campaign_id, $get_quarantine_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignQuarantineOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignRegion_0($campaign_id): \OpenAPI\Client\Model\GetCampaignRegionResponse
```
...
try {
    $result = $apiInstance->getCampaignRegion_0($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignRegion_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignSettings_0($campaign_id): \OpenAPI\Client\Model\GetCampaignSettingsResponse
```
...
try {
    $result = $apiInstance->getCampaignSettings_0($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignSettings_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaign_0($campaign_id): \OpenAPI\Client\Model\GetCampaignResponse
```
...
try {
    $result = $apiInstance->getCampaign_0($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaign_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignsByLogin_0($login, $page, $page_size): \OpenAPI\Client\Model\GetCampaignsResponse
```
...
try {
    $result = $apiInstance->getCampaignsByLogin_0($login, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaignsByLogin_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaigns_0($page, $page_size): \OpenAPI\Client\Model\GetCampaignsResponse
```
...
try {
    $result = $apiInstance->getCampaigns_0($page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCampaigns_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCategoriesMaxSaleQuantum_2($get_categories_max_sale_quantum_request): \OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumResponse
```
...
try {
    $result = $apiInstance->getCategoriesMaxSaleQuantum_2($get_categories_max_sale_quantum_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCategoriesMaxSaleQuantum_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCategoriesTree_2($get_categories_request): \OpenAPI\Client\Model\GetCategoriesResponse
```
...
try {
    $result = $apiInstance->getCategoriesTree_2($get_categories_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCategoriesTree_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCategoryContentParameters_0($category_id): \OpenAPI\Client\Model\GetCategoryContentParametersResponse
```
...
try {
    $result = $apiInstance->getCategoryContentParameters_0($category_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getCategoryContentParameters_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getChatHistory_0($business_id, $chat_id, $get_chat_history_request, $page_token, $limit): \OpenAPI\Client\Model\GetChatHistoryResponse
```
...
try {
    $result = $apiInstance->getChatHistory_0($business_id, $chat_id, $get_chat_history_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getChatHistory_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getChats_0($business_id, $get_chats_request, $page_token, $limit): \OpenAPI\Client\Model\GetChatsResponse
```
...
try {
    $result = $apiInstance->getChats_0($business_id, $get_chats_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getChats_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getDeliveryServices_1(): \OpenAPI\Client\Model\GetDeliveryServicesResponse
```
...
try {
    $result = $apiInstance->getDeliveryServices_1();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getDeliveryServices_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeedIndexLogs_0($campaign_id, $feed_id, $limit, $published_time_from, $published_time_to, $status): \OpenAPI\Client\Model\GetFeedIndexLogsResponse
```
...
try {
    $result = $apiInstance->getFeedIndexLogs_0($campaign_id, $feed_id, $limit, $published_time_from, $published_time_to, $status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getFeedIndexLogs_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeed_0($campaign_id, $feed_id): \OpenAPI\Client\Model\GetFeedResponse
```
...
try {
    $result = $apiInstance->getFeed_0($campaign_id, $feed_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getFeed_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeedbackAndCommentUpdates_0($campaign_id, $page_token, $limit, $from_date): \OpenAPI\Client\Model\GetFeedbackListResponse
```
...
try {
    $result = $apiInstance->getFeedbackAndCommentUpdates_0($campaign_id, $page_token, $limit, $from_date);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getFeedbackAndCommentUpdates_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeeds_0($campaign_id): \OpenAPI\Client\Model\GetFeedsResponse
```
...
try {
    $result = $apiInstance->getFeeds_0($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getFeeds_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGoodsFeedbackComments_2($business_id, $get_goods_feedback_comments_request, $page_token, $limit): \OpenAPI\Client\Model\GetGoodsFeedbackCommentsResponse
```
...
try {
    $result = $apiInstance->getGoodsFeedbackComments_2($business_id, $get_goods_feedback_comments_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getGoodsFeedbackComments_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGoodsFeedbacks_2($business_id, $page_token, $limit, $get_goods_feedback_request): \OpenAPI\Client\Model\GetGoodsFeedbackResponse
```
...
try {
    $result = $apiInstance->getGoodsFeedbacks_2($business_id, $page_token, $limit, $get_goods_feedback_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getGoodsFeedbacks_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGoodsStats_3($campaign_id, $get_goods_stats_request): \OpenAPI\Client\Model\GetGoodsStatsResponse
```
...
try {
    $result = $apiInstance->getGoodsStats_3($campaign_id, $get_goods_stats_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getGoodsStats_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getHiddenOffers_2($campaign_id, $offer_id, $page_token, $limit, $offset, $page, $page_size): \OpenAPI\Client\Model\GetHiddenOffersResponse
```
...
try {
    $result = $apiInstance->getHiddenOffers_2($campaign_id, $offer_id, $page_token, $limit, $offset, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getHiddenOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getModelOffers_0($model_id, $region_id, $currency, $order_by_price, $count, $page): \OpenAPI\Client\Model\GetModelsOffersResponse
```
...
try {
    $result = $apiInstance->getModelOffers_0($model_id, $region_id, $currency, $order_by_price, $count, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getModelOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getModel_0($model_id, $region_id, $currency): \OpenAPI\Client\Model\GetModelsResponse
```
...
try {
    $result = $apiInstance->getModel_0($model_id, $region_id, $currency);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getModel_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getModelsOffers_0($region_id, $get_models_request, $currency, $order_by_price): \OpenAPI\Client\Model\GetModelsOffersResponse
```
...
try {
    $result = $apiInstance->getModelsOffers_0($region_id, $get_models_request, $currency, $order_by_price);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getModelsOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getModels_0($region_id, $get_models_request, $currency): \OpenAPI\Client\Model\GetModelsResponse
```
...
try {
    $result = $apiInstance->getModels_0($region_id, $get_models_request, $currency);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getModels_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOfferCardsContentStatus_0($business_id, $page_token, $limit, $get_offer_cards_content_status_request): \OpenAPI\Client\Model\GetOfferCardsContentStatusResponse
```
...
try {
    $result = $apiInstance->getOfferCardsContentStatus_0($business_id, $page_token, $limit, $get_offer_cards_content_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOfferCardsContentStatus_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOfferMappingEntries_3($campaign_id, $offer_id, $shop_sku, $mapping_kind, $status, $availability, $category_id, $vendor, $page_token, $limit): \OpenAPI\Client\Model\GetOfferMappingEntriesResponse
```
...
try {
    $result = $apiInstance->getOfferMappingEntries_3($campaign_id, $offer_id, $shop_sku, $mapping_kind, $status, $availability, $category_id, $vendor, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOfferMappingEntries_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOfferMappings_0($business_id, $page_token, $limit, $get_offer_mappings_request): \OpenAPI\Client\Model\GetOfferMappingsResponse
```
...
try {
    $result = $apiInstance->getOfferMappings_0($business_id, $page_token, $limit, $get_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOfferMappings_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOfferRecommendations_0($business_id, $get_offer_recommendations_request, $page_token, $limit): \OpenAPI\Client\Model\GetOfferRecommendationsResponse
```
...
try {
    $result = $apiInstance->getOfferRecommendations_0($business_id, $get_offer_recommendations_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOfferRecommendations_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOffers_0($campaign_id, $query, $feed_id, $shop_category_id, $currency, $matched, $page, $page_size): \OpenAPI\Client\Model\GetOffersResponse
```
...
try {
    $result = $apiInstance->getOffers_0($campaign_id, $query, $feed_id, $shop_category_id, $currency, $matched, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderBusinessBuyerInfo_2($campaign_id, $order_id): \OpenAPI\Client\Model\GetBusinessBuyerInfoResponse
```
...
try {
    $result = $apiInstance->getOrderBusinessBuyerInfo_2($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrderBusinessBuyerInfo_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderBusinessDocumentsInfo_2($campaign_id, $order_id): \OpenAPI\Client\Model\GetBusinessDocumentsInfoResponse
```
...
try {
    $result = $apiInstance->getOrderBusinessDocumentsInfo_2($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrderBusinessDocumentsInfo_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderBuyerInfo_0($campaign_id, $order_id): \OpenAPI\Client\Model\GetOrderBuyerInfoResponse
```
...
try {
    $result = $apiInstance->getOrderBuyerInfo_0($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrderBuyerInfo_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrderLabelsData_1($campaign_id, $order_id): \OpenAPI\Client\Model\GetOrderLabelsDataResponse
```
...
try {
    $result = $apiInstance->getOrderLabelsData_1($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrderLabelsData_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrder_2($campaign_id, $order_id): \OpenAPI\Client\Model\GetOrderResponse
```
...
try {
    $result = $apiInstance->getOrder_2($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrder_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrdersStats_2($campaign_id, $page_token, $limit, $get_orders_stats_request): \OpenAPI\Client\Model\GetOrdersStatsResponse
```
...
try {
    $result = $apiInstance->getOrdersStats_2($campaign_id, $page_token, $limit, $get_orders_stats_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrdersStats_2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getOrders_1($campaign_id, $order_ids, $status, $substatus, $from_date, $to_date, $supplier_shipment_date_from, $supplier_shipment_date_to, $updated_at_from, $updated_at_to, $dispatch_type, $fake, $has_cis, $only_waiting_for_cancellation_approve, $only_estimated_delivery, $buyer_type, $page, $page_size, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOrders_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOutletLicenses_0($campaign_id, $outlet_ids, $ids): \OpenAPI\Client\Model\GetOutletLicensesResponse
```
...
try {
    $result = $apiInstance->getOutletLicenses_0($campaign_id, $outlet_ids, $ids);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOutletLicenses_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOutlet_0($campaign_id, $outlet_id): \OpenAPI\Client\Model\GetOutletResponse
```
...
try {
    $result = $apiInstance->getOutlet_0($campaign_id, $outlet_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOutlet_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOutlets_0($campaign_id, $page_token, $region_id, $shop_outlet_code, $region_id2): \OpenAPI\Client\Model\GetOutletsResponse
```
...
try {
    $result = $apiInstance->getOutlets_0($campaign_id, $page_token, $region_id, $shop_outlet_code, $region_id2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getOutlets_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPricesByOfferIds_2($campaign_id, $page_token, $limit, $get_prices_by_offer_ids_request): \OpenAPI\Client\Model\GetPricesByOfferIdsResponse
```
...
try {
    $result = $apiInstance->getPricesByOfferIds_2($campaign_id, $page_token, $limit, $get_prices_by_offer_ids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getPricesByOfferIds_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPrices_2($campaign_id, $page_token, $limit, $archived): \OpenAPI\Client\Model\GetPricesResponse
```
...
try {
    $result = $apiInstance->getPrices_2($campaign_id, $page_token, $limit, $archived);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getPrices_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPromoOffers_2($business_id, $get_promo_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetPromoOffersResponse
```
...
try {
    $result = $apiInstance->getPromoOffers_2($business_id, $get_promo_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getPromoOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPromos_2($business_id, $get_promos_request): \OpenAPI\Client\Model\GetPromosResponse
```
...
try {
    $result = $apiInstance->getPromos_2($business_id, $get_promos_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getPromos_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getQualityRatingDetails_1($campaign_id): \OpenAPI\Client\Model\GetQualityRatingDetailsResponse
```
...
try {
    $result = $apiInstance->getQualityRatingDetails_1($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getQualityRatingDetails_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getQualityRatings_2($business_id, $get_quality_rating_request): \OpenAPI\Client\Model\GetQualityRatingResponse
```
...
try {
    $result = $apiInstance->getQualityRatings_2($business_id, $get_quality_rating_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getQualityRatings_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReportInfo_1($report_id): \OpenAPI\Client\Model\GetReportInfoResponse
```
...
try {
    $result = $apiInstance->getReportInfo_1($report_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getReportInfo_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturnApplication_1($campaign_id, $order_id, $return_id): \SplFileObject
```
...
try {
    $result = $apiInstance->getReturnApplication_1($campaign_id, $order_id, $return_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getReturnApplication_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturnPhoto_1($campaign_id, $order_id, $return_id, $item_id, $image_hash): \SplFileObject
```
...
try {
    $result = $apiInstance->getReturnPhoto_1($campaign_id, $order_id, $return_id, $item_id, $image_hash);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getReturnPhoto_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturn_1($campaign_id, $order_id, $return_id): \OpenAPI\Client\Model\GetReturnResponse
```
...
try {
    $result = $apiInstance->getReturn_1($campaign_id, $order_id, $return_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getReturn_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturns_1($campaign_id, $page_token, $limit, $order_ids, $statuses, $type, $from_date, $to_date, $from_date2, $to_date2): \OpenAPI\Client\Model\GetReturnsResponse
```
...
try {
    $result = $apiInstance->getReturns_1($campaign_id, $page_token, $limit, $order_ids, $statuses, $type, $from_date, $to_date, $from_date2, $to_date2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getReturns_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getStocks_2($campaign_id, $page_token, $limit, $get_warehouse_stocks_request): \OpenAPI\Client\Model\GetWarehouseStocksResponse
```
...
try {
    $result = $apiInstance->getStocks_2($campaign_id, $page_token, $limit, $get_warehouse_stocks_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getStocks_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSuggestedOfferMappingEntries_3($campaign_id, $get_suggested_offer_mapping_entries_request): \OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesResponse
```
...
try {
    $result = $apiInstance->getSuggestedOfferMappingEntries_3($campaign_id, $get_suggested_offer_mapping_entries_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getSuggestedOfferMappingEntries_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSuggestedOfferMappings_0($business_id, $get_suggested_offer_mappings_request): \OpenAPI\Client\Model\GetSuggestedOfferMappingsResponse
```
...
try {
    $result = $apiInstance->getSuggestedOfferMappings_0($business_id, $get_suggested_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getSuggestedOfferMappings_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSuggestedPrices_3($campaign_id, $suggest_prices_request): \OpenAPI\Client\Model\SuggestPricesResponse
```
...
try {
    $result = $apiInstance->getSuggestedPrices_3($campaign_id, $suggest_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getSuggestedPrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getWarehouses_1($business_id): \OpenAPI\Client\Model\GetWarehousesResponse
```
...
try {
    $result = $apiInstance->getWarehouses_1($business_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->getWarehouses_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
provideOrderDigitalCodes_0($campaign_id, $order_id, $provide_order_digital_codes_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->provideOrderDigitalCodes_0($campaign_id, $order_id, $provide_order_digital_codes_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->provideOrderDigitalCodes_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
provideOrderItemIdentifiers_1($campaign_id, $order_id, $provide_order_item_identifiers_request): \OpenAPI\Client\Model\ProvideOrderItemIdentifiersResponse
```
...
try {
    $result = $apiInstance->provideOrderItemIdentifiers_1($campaign_id, $order_id, $provide_order_item_identifiers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->provideOrderItemIdentifiers_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putBidsForBusiness_0($business_id, $put_sku_bids_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->putBidsForBusiness_0($business_id, $put_sku_bids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->putBidsForBusiness_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putBidsForCampaign_0($campaign_id, $put_sku_bids_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->putBidsForCampaign_0($campaign_id, $put_sku_bids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->putBidsForCampaign_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
refreshFeed_0($campaign_id, $feed_id): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->refreshFeed_0($campaign_id, $feed_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->refreshFeed_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
searchModels_0($query, $region_id, $currency, $page, $page_size): \OpenAPI\Client\Model\SearchModelsResponse
```
...
try {
    $result = $apiInstance->searchModels_0($query, $region_id, $currency, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->searchModels_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
searchRegionChildren_2($region_id, $page, $page_size): \OpenAPI\Client\Model\GetRegionWithChildrenResponse
```
...
try {
    $result = $apiInstance->searchRegionChildren_2($region_id, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->searchRegionChildren_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
searchRegionsById_2($region_id): \OpenAPI\Client\Model\GetRegionsResponse
```
...
try {
    $result = $apiInstance->searchRegionsById_2($region_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->searchRegionsById_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
searchRegionsByName_2($name, $page_token, $limit): \OpenAPI\Client\Model\GetRegionsResponse
```
...
try {
    $result = $apiInstance->searchRegionsByName_2($name, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->searchRegionsByName_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
sendFileToChat_0($business_id, $chat_id, $file): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->sendFileToChat_0($business_id, $chat_id, $file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->sendFileToChat_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
sendMessageToChat_0($business_id, $chat_id, $send_message_to_chat_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->sendMessageToChat_0($business_id, $chat_id, $send_message_to_chat_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->sendMessageToChat_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setFeedParams_0($campaign_id, $feed_id, $set_feed_params_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->setFeedParams_0($campaign_id, $feed_id, $set_feed_params_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setFeedParams_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setOrderBoxLayout_2($campaign_id, $order_id, $set_order_box_layout_request): \OpenAPI\Client\Model\SetOrderBoxLayoutResponse
```
...
try {
    $result = $apiInstance->setOrderBoxLayout_2($campaign_id, $order_id, $set_order_box_layout_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setOrderBoxLayout_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setOrderDeliveryDate_0($campaign_id, $order_id, $set_order_delivery_date_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->setOrderDeliveryDate_0($campaign_id, $order_id, $set_order_delivery_date_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setOrderDeliveryDate_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setOrderDeliveryTrackCode_0($campaign_id, $order_id, $set_order_delivery_track_code_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->setOrderDeliveryTrackCode_0($campaign_id, $order_id, $set_order_delivery_track_code_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setOrderDeliveryTrackCode_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setOrderShipmentBoxes_1($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request): \OpenAPI\Client\Model\SetOrderShipmentBoxesResponse
```
...
try {
    $result = $apiInstance->setOrderShipmentBoxes_1($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setOrderShipmentBoxes_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setReturnDecision_0($campaign_id, $order_id, $return_id, $set_return_decision_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->setReturnDecision_0($campaign_id, $order_id, $return_id, $set_return_decision_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->setReturnDecision_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
skipGoodsFeedbacksReaction_2($business_id, $skip_goods_feedback_reaction_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->skipGoodsFeedbacksReaction_2($business_id, $skip_goods_feedback_reaction_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->skipGoodsFeedbacksReaction_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
submitReturnDecision_0($campaign_id, $order_id, $return_id): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->submitReturnDecision_0($campaign_id, $order_id, $return_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->submitReturnDecision_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateBusinessPrices_2($business_id, $update_business_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateBusinessPrices_2($business_id, $update_business_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateBusinessPrices_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateCampaignOffers_0($campaign_id, $update_campaign_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateCampaignOffers_0($campaign_id, $update_campaign_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateCampaignOffers_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateGoodsFeedbackComment_2($business_id, $update_goods_feedback_comment_request): \OpenAPI\Client\Model\UpdateGoodsFeedbackCommentResponse
```
...
try {
    $result = $apiInstance->updateGoodsFeedbackComment_2($business_id, $update_goods_feedback_comment_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateGoodsFeedbackComment_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOfferContent_0($business_id, $update_offer_content_request): \OpenAPI\Client\Model\UpdateOfferContentResponse
```
...
try {
    $result = $apiInstance->updateOfferContent_0($business_id, $update_offer_content_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOfferContent_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOfferMappingEntries_3($campaign_id, $update_offer_mapping_entry_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateOfferMappingEntries_3($campaign_id, $update_offer_mapping_entry_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOfferMappingEntries_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOfferMappings_0($business_id, $update_offer_mappings_request): \OpenAPI\Client\Model\UpdateOfferMappingsResponse
```
...
try {
    $result = $apiInstance->updateOfferMappings_0($business_id, $update_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOfferMappings_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderItems_1($campaign_id, $order_id, $update_order_item_request)
```
...
try {
    $apiInstance->updateOrderItems_1($campaign_id, $order_id, $update_order_item_request);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOrderItems_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderStatus_1($campaign_id, $order_id, $update_order_status_request): \OpenAPI\Client\Model\UpdateOrderStatusResponse
```
...
try {
    $result = $apiInstance->updateOrderStatus_1($campaign_id, $order_id, $update_order_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOrderStatus_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderStatuses_1($campaign_id, $update_order_statuses_request): \OpenAPI\Client\Model\UpdateOrderStatusesResponse
```
...
try {
    $result = $apiInstance->updateOrderStatuses_1($campaign_id, $update_order_statuses_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOrderStatuses_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderStorageLimit_0($campaign_id, $order_id, $update_order_storage_limit_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateOrderStorageLimit_0($campaign_id, $order_id, $update_order_storage_limit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOrderStorageLimit_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOutletLicenses_0($campaign_id, $update_outlet_license_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateOutletLicenses_0($campaign_id, $update_outlet_license_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOutletLicenses_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOutlet_0($campaign_id, $outlet_id, $change_outlet_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateOutlet_0($campaign_id, $outlet_id, $change_outlet_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateOutlet_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updatePrices_2($campaign_id, $update_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updatePrices_2($campaign_id, $update_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updatePrices_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updatePromoOffers_2($business_id, $update_promo_offers_request): \OpenAPI\Client\Model\UpdatePromoOffersResponse
```
...
try {
    $result = $apiInstance->updatePromoOffers_2($business_id, $update_promo_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updatePromoOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateStocks_1($campaign_id, $update_stocks_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateStocks_1($campaign_id, $update_stocks_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DbsApi->updateStocks_1: ', $e->getMessage(), PHP_EOL;
}
```
