...
| ------------- | ------------- | ------------- |
| [**addHiddenOffers_3()**](ExpressApi.md#addHiddenOffers_3) | **POST** /campaigns/{campaignId}/hidden-offers | Скрытие товаров и настройки скрытия |
| [**addOffersToArchive_3()**](ExpressApi.md#addOffersToArchive_3) | **POST** /businesses/{businessId}/offer-mappings/archive | Добавление товаров в архив |
| [**calculateTariffs_3()**](ExpressApi.md#calculateTariffs_3) | **POST** /tariffs/calculate | Калькулятор стоимости услуг |
| [**confirmBusinessPrices_3()**](ExpressApi.md#confirmBusinessPrices_3) | **POST** /businesses/{businessId}/price-quarantine/confirm | Удаление товара из карантина по цене в кабинете |
| [**confirmCampaignPrices_3()**](ExpressApi.md#confirmCampaignPrices_3) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Удаление товара из карантина по цене в магазине |
| [**createChat_3()**](ExpressApi.md#createChat_3) | **POST** /businesses/{businessId}/chats/new | Создание нового чата с покупателем |
| [**deleteCampaignOffers_3()**](ExpressApi.md#deleteCampaignOffers_3) | **POST** /campaigns/{campaignId}/offers/delete | Удаление товаров из ассортимента магазина |
| [**deleteGoodsFeedbackComment_3()**](ExpressApi.md#deleteGoodsFeedbackComment_3) | **POST** /businesses/{businessId}/goods-feedback/comments/delete | Удаление комментария к отзыву |
| [**deleteHiddenOffers_3()**](ExpressApi.md#deleteHiddenOffers_3) | **POST** /campaigns/{campaignId}/hidden-offers/delete | Возобновление показа товаров |
| [**deleteOffersFromArchive_3()**](ExpressApi.md#deleteOffersFromArchive_3) | **POST** /businesses/{businessId}/offer-mappings/unarchive | Удаление товаров из архива |
| [**deleteOffers_3()**](ExpressApi.md#deleteOffers_3) | **POST** /businesses/{businessId}/offer-mappings/delete | Удаление товаров из каталога |
| [**deletePromoOffers_3()**](ExpressApi.md#deletePromoOffers_3) | **POST** /businesses/{businessId}/promos/offers/delete | Удаление товаров из акции |
| [**generateBoostConsolidatedReport_3()**](ExpressApi.md#generateBoostConsolidatedReport_3) | **POST** /reports/boost-consolidated/generate | Отчет по бусту продаж |
| [**generateCompetitorsPositionReport_3()**](ExpressApi.md#generateCompetitorsPositionReport_3) | **POST** /reports/competitors-position/generate | Отчет «Конкурентная позиция» |
| [**generateGoodsFeedbackReport_3()**](ExpressApi.md#generateGoodsFeedbackReport_3) | **POST** /reports/goods-feedback/generate | Отчет по отзывам о товарах |
| [**generateGoodsRealizationReport_2()**](ExpressApi.md#generateGoodsRealizationReport_2) | **POST** /reports/goods-realization/generate | Отчет по реализации |
| [**generateMassOrderLabelsReport_2()**](ExpressApi.md#generateMassOrderLabelsReport_2) | **POST** /reports/documents/labels/generate | Готовые ярлыки‑наклейки на все коробки в нескольких заказах |
| [**generateOrderLabel_2()**](ExpressApi.md#generateOrderLabel_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes/{boxId}/label | Готовый ярлык‑наклейка для коробки в заказе |
| [**generateOrderLabels_2()**](ExpressApi.md#generateOrderLabels_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels | Готовые ярлыки‑наклейки на все коробки в одном заказе |
| [**generatePricesReport_3()**](ExpressApi.md#generatePricesReport_3) | **POST** /reports/prices/generate | Отчет «Цены на рынке» |
| [**generateShelfsStatisticsReport_3()**](ExpressApi.md#generateShelfsStatisticsReport_3) | **POST** /reports/shelf-statistics/generate | Отчет по полкам |
| [**generateShowsSalesReport_3()**](ExpressApi.md#generateShowsSalesReport_3) | **POST** /reports/shows-sales/generate | Отчет «Аналитика продаж» |
| [**generateStocksOnWarehousesReport_3()**](ExpressApi.md#generateStocksOnWarehousesReport_3) | **POST** /reports/stocks-on-warehouses/generate | Отчет по остаткам на складах |
| [**generateUnitedMarketplaceServicesReport_3()**](ExpressApi.md#generateUnitedMarketplaceServicesReport_3) | **POST** /reports/united-marketplace-services/generate | Отчет по стоимости услуг |
| [**generateUnitedNettingReport_3()**](ExpressApi.md#generateUnitedNettingReport_3) | **POST** /reports/united-netting/generate | Отчет по платежам |
| [**generateUnitedOrdersReport_3()**](ExpressApi.md#generateUnitedOrdersReport_3) | **POST** /reports/united-orders/generate | Отчет по заказам |
| [**getAllOffers_2()**](ExpressApi.md#getAllOffers_2) | **GET** /campaigns/{campaignId}/offers/all | Все предложения магазина |
| [**getBidsInfoForBusiness_3()**](ExpressApi.md#getBidsInfoForBusiness_3) | **POST** /businesses/{businessId}/bids/info | Информация об установленных ставках |
| [**getBidsRecommendations_3()**](ExpressApi.md#getBidsRecommendations_3) | **POST** /businesses/{businessId}/bids/recommendations | Рекомендованные ставки для заданных товаров |
| [**getBusinessQuarantineOffers_3()**](ExpressApi.md#getBusinessQuarantineOffers_3) | **POST** /businesses/{businessId}/price-quarantine | Список товаров, находящихся в карантине по цене в кабинете |
| [**getBusinessSettings_3()**](ExpressApi.md#getBusinessSettings_3) | **POST** /businesses/{businessId}/settings | Настройки кабинета |
| [**getCampaignLogins_1()**](ExpressApi.md#getCampaignLogins_1) | **GET** /campaigns/{campaignId}/logins | Логины, связанные с магазином |
| [**getCampaignOffers_3()**](ExpressApi.md#getCampaignOffers_3) | **POST** /campaigns/{campaignId}/offers | Информация о товарах, которые размещены в заданном магазине |
| [**getCampaignQuarantineOffers_3()**](ExpressApi.md#getCampaignQuarantineOffers_3) | **POST** /campaigns/{campaignId}/price-quarantine | Список товаров, находящихся в карантине по цене в магазине |
| [**getCampaignRegion_3()**](ExpressApi.md#getCampaignRegion_3) | **GET** /campaigns/{campaignId}/region | Регион магазина |
| [**getCampaignSettings_2()**](ExpressApi.md#getCampaignSettings_2) | **GET** /campaigns/{campaignId}/settings | Настройки магазина |
| [**getCampaign_1()**](ExpressApi.md#getCampaign_1) | **GET** /campaigns/{campaignId} | Информация о магазине |
| [**getCampaignsByLogin_1()**](ExpressApi.md#getCampaignsByLogin_1) | **GET** /campaigns/by_login/{login} | Магазины, доступные логину |
| [**getCampaigns_1()**](ExpressApi.md#getCampaigns_1) | **GET** /campaigns | Список магазинов пользователя |
| [**getCategoriesMaxSaleQuantum_3()**](ExpressApi.md#getCategoriesMaxSaleQuantum_3) | **POST** /categories/max-sale-quantum | Лимит на установку кванта продажи и минимального количества товаров в заказе |
| [**getCategoriesTree_3()**](ExpressApi.md#getCategoriesTree_3) | **POST** /categories/tree | Дерево категорий |
| [**getCategoryContentParameters_3()**](ExpressApi.md#getCategoryContentParameters_3) | **POST** /category/{categoryId}/parameters | Списки характеристик товаров по категориям |
| [**getChatHistory_3()**](ExpressApi.md#getChatHistory_3) | **POST** /businesses/{businessId}/chats/history | Получение истории сообщений в чате |
| [**getChats_3()**](ExpressApi.md#getChats_3) | **POST** /businesses/{businessId}/chats | Получение доступных чатов |
| [**getDeliveryServices_2()**](ExpressApi.md#getDeliveryServices_2) | **GET** /delivery/services | Справочник служб доставки |
| [**getFeedIndexLogs_2()**](ExpressApi.md#getFeedIndexLogs_2) | **GET** /campaigns/{campaignId}/feeds/{feedId}/index-logs | Отчет по индексации прайс-листа |
| [**getFeed_2()**](ExpressApi.md#getFeed_2) | **GET** /campaigns/{campaignId}/feeds/{feedId} | Информация о прайс-листе |
| [**getFeedbackAndCommentUpdates_3()**](ExpressApi.md#getFeedbackAndCommentUpdates_3) | **GET** /campaigns/{campaignId}/feedback/updates | Новые и обновленные отзывы о магазине |
| [**getFeeds_2()**](ExpressApi.md#getFeeds_2) | **GET** /campaigns/{campaignId}/feeds | Список прайс-листов магазина |
| [**getGoodsFeedbackComments_3()**](ExpressApi.md#getGoodsFeedbackComments_3) | **POST** /businesses/{businessId}/goods-feedback/comments | Получение комментариев к отзыву |
| [**getGoodsFeedbacks_3()**](ExpressApi.md#getGoodsFeedbacks_3) | **POST** /businesses/{businessId}/goods-feedback | Получение отзывов о товарах продавца |
| [**getGoodsStats_2()**](ExpressApi.md#getGoodsStats_2) | **POST** /campaigns/{campaignId}/stats/skus | Отчет по товарам |
| [**getHiddenOffers_3()**](ExpressApi.md#getHiddenOffers_3) | **GET** /campaigns/{campaignId}/hidden-offers | Информация о скрытых вами товарах |
| [**getOfferCardsContentStatus_3()**](ExpressApi.md#getOfferCardsContentStatus_3) | **POST** /businesses/{businessId}/offer-cards | Получение информации о заполненности карточек магазина |
| [**getOfferMappingEntries_2()**](ExpressApi.md#getOfferMappingEntries_2) | **GET** /campaigns/{campaignId}/offer-mapping-entries | Список товаров в каталоге |
| [**getOfferMappings_3()**](ExpressApi.md#getOfferMappings_3) | **POST** /businesses/{businessId}/offer-mappings | Информация о товарах в каталоге |
| [**getOfferRecommendations_3()**](ExpressApi.md#getOfferRecommendations_3) | **POST** /businesses/{businessId}/offers/recommendations | Рекомендации Маркета, касающиеся цен |
| [**getOffers_2()**](ExpressApi.md#getOffers_2) | **GET** /campaigns/{campaignId}/offers | Предложения магазина |
| [**getOrderBusinessBuyerInfo_3()**](ExpressApi.md#getOrderBusinessBuyerInfo_3) | **POST** /campaigns/{campaignId}/orders/{orderId}/business-buyer | Информация о покупателе — юридическом лице |
| [**getOrderBusinessDocumentsInfo_3()**](ExpressApi.md#getOrderBusinessDocumentsInfo_3) | **POST** /campaigns/{campaignId}/orders/{orderId}/documents | Информация о документах |
| [**getOrderLabelsData_2()**](ExpressApi.md#getOrderLabelsData_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels/data | Данные для самостоятельного изготовления ярлыков |
| [**getOrder_3()**](ExpressApi.md#getOrder_3) | **GET** /campaigns/{campaignId}/orders/{orderId} | Информация об одном заказе |
| [**getOrdersStats_3()**](ExpressApi.md#getOrdersStats_3) | **POST** /campaigns/{campaignId}/stats/orders | Детальная информация по заказам |
| [**getOrders_3()**](ExpressApi.md#getOrders_3) | **GET** /campaigns/{campaignId}/orders | Информация о нескольких заказах |
| [**getPricesByOfferIds_3()**](ExpressApi.md#getPricesByOfferIds_3) | **POST** /campaigns/{campaignId}/offer-prices | Просмотр цен на указанные товары в магазине |
| [**getPrices_3()**](ExpressApi.md#getPrices_3) | **GET** /campaigns/{campaignId}/offer-prices | Список цен |
| [**getPromoOffers_3()**](ExpressApi.md#getPromoOffers_3) | **POST** /businesses/{businessId}/promos/offers | Получение списка товаров, которые участвуют или могут участвовать в акции |
| [**getPromos_3()**](ExpressApi.md#getPromos_3) | **POST** /businesses/{businessId}/promos | Получение списка акций |
| [**getQualityRatingDetails_2()**](ExpressApi.md#getQualityRatingDetails_2) | **POST** /campaigns/{campaignId}/ratings/quality/details | Заказы, которые повлияли на индекс качества |
| [**getQualityRatings_3()**](ExpressApi.md#getQualityRatings_3) | **POST** /businesses/{businessId}/ratings/quality | Индекс качества магазинов |
| [**getReportInfo_3()**](ExpressApi.md#getReportInfo_3) | **GET** /reports/info/{reportId} | Получение заданного отчета |
| [**getReturnApplication_2()**](ExpressApi.md#getReturnApplication_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/application | Получение заявления на возврат |
| [**getReturnPhoto_2()**](ExpressApi.md#getReturnPhoto_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId}/decision/{itemId}/image/{imageHash} | Получение фотографии возврата |
| [**getReturn_2()**](ExpressApi.md#getReturn_2) | **GET** /campaigns/{campaignId}/orders/{orderId}/returns/{returnId} | Информация о невыкупе или возврате |
| [**getReturns_2()**](ExpressApi.md#getReturns_2) | **GET** /campaigns/{campaignId}/returns | Список невыкупов и возвратов |
| [**getStocks_3()**](ExpressApi.md#getStocks_3) | **POST** /campaigns/{campaignId}/offers/stocks | Информация об остатках и оборачиваемости |
| [**getSuggestedOfferMappingEntries_2()**](ExpressApi.md#getSuggestedOfferMappingEntries_2) | **POST** /campaigns/{campaignId}/offer-mapping-entries/suggestions | Рекомендованные карточки для товаров |
| [**getSuggestedOfferMappings_3()**](ExpressApi.md#getSuggestedOfferMappings_3) | **POST** /businesses/{businessId}/offer-mappings/suggestions | Просмотр карточек на Маркете, которые подходят вашим товарам |
| [**getSuggestedPrices_2()**](ExpressApi.md#getSuggestedPrices_2) | **POST** /campaigns/{campaignId}/offer-prices/suggestions | Цены для продвижения товаров |
| [**getWarehouses_2()**](ExpressApi.md#getWarehouses_2) | **GET** /businesses/{businessId}/warehouses | Список складов и групп складов |
| [**provideOrderItemIdentifiers_2()**](ExpressApi.md#provideOrderItemIdentifiers_2) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача кодов маркировки единиц товара |
| [**putBidsForBusiness_3()**](ExpressApi.md#putBidsForBusiness_3) | **PUT** /businesses/{businessId}/bids | Включение буста продаж и установка ставок |
| [**putBidsForCampaign_2()**](ExpressApi.md#putBidsForCampaign_2) | **PUT** /campaigns/{campaignId}/bids | Включение буста продаж и установка ставок для магазина |
| [**refreshFeed_2()**](ExpressApi.md#refreshFeed_2) | **POST** /campaigns/{campaignId}/feeds/{feedId}/refresh | Сообщить, что прайс-лист обновился |
| [**searchRegionChildren_3()**](ExpressApi.md#searchRegionChildren_3) | **GET** /regions/{regionId}/children | Информация о дочерних регионах |
| [**searchRegionsById_3()**](ExpressApi.md#searchRegionsById_3) | **GET** /regions/{regionId} | Информация о регионе |
| [**searchRegionsByName_3()**](ExpressApi.md#searchRegionsByName_3) | **GET** /regions | Поиск регионов по их имени |
| [**sendFileToChat_3()**](ExpressApi.md#sendFileToChat_3) | **POST** /businesses/{businessId}/chats/file/send | Отправка файла в чат |
| [**sendMessageToChat_3()**](ExpressApi.md#sendMessageToChat_3) | **POST** /businesses/{businessId}/chats/message | Отправка сообщения в чат |
| [**setFeedParams_2()**](ExpressApi.md#setFeedParams_2) | **POST** /campaigns/{campaignId}/feeds/{feedId}/params | Изменение параметров прайс-листа |
| [**setOrderBoxLayout_1()**](ExpressApi.md#setOrderBoxLayout_1) | **PUT** /campaigns/{campaignId}/orders/{orderId}/boxes | Подготовка заказа |
| [**setOrderShipmentBoxes_2()**](ExpressApi.md#setOrderShipmentBoxes_2) | **PUT** /campaigns/{campaignId}/orders/{orderId}/delivery/shipments/{shipmentId}/boxes | Передача количества грузовых мест в заказе |
| [**skipGoodsFeedbacksReaction_3()**](ExpressApi.md#skipGoodsFeedbacksReaction_3) | **POST** /businesses/{businessId}/goods-feedback/skip-reaction | Отказ от ответа на отзывы |
| [**updateBusinessPrices_3()**](ExpressApi.md#updateBusinessPrices_3) | **POST** /businesses/{businessId}/offer-prices/updates | Установка цен на товары во всех магазинах |
| [**updateCampaignOffers_3()**](ExpressApi.md#updateCampaignOffers_3) | **POST** /campaigns/{campaignId}/offers/update | Изменение условий продажи товаров в магазине |
| [**updateGoodsFeedbackComment_3()**](ExpressApi.md#updateGoodsFeedbackComment_3) | **POST** /businesses/{businessId}/goods-feedback/comments/update | Добавление нового или изменение созданного комментария |
| [**updateOfferContent_3()**](ExpressApi.md#updateOfferContent_3) | **POST** /businesses/{businessId}/offer-cards/update | Редактирование категорийных характеристик товара |
| [**updateOfferMappingEntries_2()**](ExpressApi.md#updateOfferMappingEntries_2) | **POST** /campaigns/{campaignId}/offer-mapping-entries/updates | Добавление и редактирование товаров в каталоге |
| [**updateOfferMappings_3()**](ExpressApi.md#updateOfferMappings_3) | **POST** /businesses/{businessId}/offer-mappings/update | Добавление товаров в каталог и изменение информации о них |
| [**updateOrderItems_2()**](ExpressApi.md#updateOrderItems_2) | **PUT** /campaigns/{campaignId}/orders/{orderId}/items | Удаление товара из заказа или уменьшение числа единиц |
| [**updateOrderStatus_2()**](ExpressApi.md#updateOrderStatus_2) | **PUT** /campaigns/{campaignId}/orders/{orderId}/status | Изменение статуса одного заказа |
| [**updateOrderStatuses_2()**](ExpressApi.md#updateOrderStatuses_2) | **POST** /campaigns/{campaignId}/orders/status-update | Изменение статусов нескольких заказов |
| [**updatePrices_3()**](ExpressApi.md#updatePrices_3) | **POST** /campaigns/{campaignId}/offer-prices/updates | Установка цен на товары в конкретном магазине |
| [**updatePromoOffers_3()**](ExpressApi.md#updatePromoOffers_3) | **POST** /businesses/{businessId}/promos/offers/update | Добавление товаров в акцию или изменение их цен |
| [**updateStocks_2()**](ExpressApi.md#updateStocks_2) | **PUT** /campaigns/{campaignId}/offers/stocks | Передача информации об остатках |
| [**verifyOrderEac_0()**](ExpressApi.md#verifyOrderEac_0) | **PUT** /campaigns/{campaignId}/orders/{orderId}/verifyEac | Передача кода подтверждения |


## `addHiddenOffers_3()`

```php
addHiddenOffers_3($campaign_id, $add_hidden_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->addHiddenOffers_3($campaign_id, $add_hidden_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->addHiddenOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `addOffersToArchive_3()`

```php
addOffersToArchive_3($business_id, $add_offers_to_archive_request): \OpenAPI\Client\Model\AddOffersToArchiveResponse
```
...
try {
    $result = $apiInstance->addOffersToArchive_3($business_id, $add_offers_to_archive_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->addOffersToArchive_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
calculateTariffs_3($calculate_tariffs_request): \OpenAPI\Client\Model\CalculateTariffsResponse
```
...
try {
    $result = $apiInstance->calculateTariffs_3($calculate_tariffs_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->calculateTariffs_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `confirmBusinessPrices_3()`

```php
confirmBusinessPrices_3($business_id, $confirm_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->confirmBusinessPrices_3($business_id, $confirm_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->confirmBusinessPrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `confirmCampaignPrices_3()`

```php
confirmCampaignPrices_3($campaign_id, $confirm_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->confirmCampaignPrices_3($campaign_id, $confirm_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->confirmCampaignPrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createChat_3($business_id, $create_chat_request): \OpenAPI\Client\Model\CreateChatResponse
```
...
try {
    $result = $apiInstance->createChat_3($business_id, $create_chat_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->createChat_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `deleteCampaignOffers_3()`

```php
deleteCampaignOffers_3($campaign_id, $delete_campaign_offers_request): \OpenAPI\Client\Model\DeleteCampaignOffersResponse
```
...
try {
    $result = $apiInstance->deleteCampaignOffers_3($campaign_id, $delete_campaign_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deleteCampaignOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `deleteGoodsFeedbackComment_3()`

```php
deleteGoodsFeedbackComment_3($business_id, $delete_goods_feedback_comment_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteGoodsFeedbackComment_3($business_id, $delete_goods_feedback_comment_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deleteGoodsFeedbackComment_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `deleteHiddenOffers_3()`

```php
deleteHiddenOffers_3($campaign_id, $delete_hidden_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->deleteHiddenOffers_3($campaign_id, $delete_hidden_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deleteHiddenOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `deleteOffersFromArchive_3()`

```php
deleteOffersFromArchive_3($business_id, $delete_offers_from_archive_request): \OpenAPI\Client\Model\DeleteOffersFromArchiveResponse
```
...
try {
    $result = $apiInstance->deleteOffersFromArchive_3($business_id, $delete_offers_from_archive_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deleteOffersFromArchive_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteOffers_3($business_id, $delete_offers_request): \OpenAPI\Client\Model\DeleteOffersResponse
```
...
try {
    $result = $apiInstance->deleteOffers_3($business_id, $delete_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deleteOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deletePromoOffers_3($business_id, $delete_promo_offers_request): \OpenAPI\Client\Model\DeletePromoOffersResponse
```
...
try {
    $result = $apiInstance->deletePromoOffers_3($business_id, $delete_promo_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->deletePromoOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateBoostConsolidatedReport_3()`

```php
generateBoostConsolidatedReport_3($generate_boost_consolidated_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateBoostConsolidatedReport_3($generate_boost_consolidated_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateBoostConsolidatedReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateCompetitorsPositionReport_3()`

```php
generateCompetitorsPositionReport_3($generate_competitors_position_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateCompetitorsPositionReport_3($generate_competitors_position_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateCompetitorsPositionReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateGoodsFeedbackReport_3()`

```php
generateGoodsFeedbackReport_3($generate_goods_feedback_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateGoodsFeedbackReport_3($generate_goods_feedback_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateGoodsFeedbackReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateGoodsRealizationReport_2()`

```php
generateGoodsRealizationReport_2($generate_goods_realization_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateGoodsRealizationReport_2($generate_goods_realization_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateGoodsRealizationReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateMassOrderLabelsReport_2()`

```php
generateMassOrderLabelsReport_2($generate_mass_order_labels_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateMassOrderLabelsReport_2($generate_mass_order_labels_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateMassOrderLabelsReport_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateOrderLabel_2()`

```php
generateOrderLabel_2($campaign_id, $order_id, $shipment_id, $box_id, $format): \SplFileObject
```
...
try {
    $result = $apiInstance->generateOrderLabel_2($campaign_id, $order_id, $shipment_id, $box_id, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateOrderLabel_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateOrderLabels_2()`

```php
generateOrderLabels_2($campaign_id, $order_id, $format): \SplFileObject
```
...
try {
    $result = $apiInstance->generateOrderLabels_2($campaign_id, $order_id, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateOrderLabels_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generatePricesReport_3()`

```php
generatePricesReport_3($generate_prices_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generatePricesReport_3($generate_prices_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generatePricesReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateShelfsStatisticsReport_3()`

```php
generateShelfsStatisticsReport_3($generate_shelfs_statistics_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateShelfsStatisticsReport_3($generate_shelfs_statistics_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateShelfsStatisticsReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateShowsSalesReport_3()`

```php
generateShowsSalesReport_3($generate_shows_sales_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateShowsSalesReport_3($generate_shows_sales_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateShowsSalesReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateStocksOnWarehousesReport_3()`

```php
generateStocksOnWarehousesReport_3($generate_stocks_on_warehouses_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateStocksOnWarehousesReport_3($generate_stocks_on_warehouses_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateStocksOnWarehousesReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateUnitedMarketplaceServicesReport_3()`

```php
generateUnitedMarketplaceServicesReport_3($generate_united_marketplace_services_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedMarketplaceServicesReport_3($generate_united_marketplace_services_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateUnitedMarketplaceServicesReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateUnitedNettingReport_3()`

```php
generateUnitedNettingReport_3($generate_united_netting_report_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedNettingReport_3($generate_united_netting_report_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateUnitedNettingReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `generateUnitedOrdersReport_3()`

```php
generateUnitedOrdersReport_3($generate_united_orders_request, $format): \OpenAPI\Client\Model\GenerateReportResponse
```
...
try {
    $result = $apiInstance->generateUnitedOrdersReport_3($generate_united_orders_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->generateUnitedOrdersReport_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAllOffers_2($campaign_id, $feed_id, $chunk): \OpenAPI\Client\Model\GetAllOffersResponse
```
...
try {
    $result = $apiInstance->getAllOffers_2($campaign_id, $feed_id, $chunk);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getAllOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getBidsInfoForBusiness_3()`

```php
getBidsInfoForBusiness_3($business_id, $page_token, $limit, $get_bids_info_request): \OpenAPI\Client\Model\GetBidsInfoResponse
```
...
try {
    $result = $apiInstance->getBidsInfoForBusiness_3($business_id, $page_token, $limit, $get_bids_info_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getBidsInfoForBusiness_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getBidsRecommendations_3()`

```php
getBidsRecommendations_3($business_id, $get_bids_recommendations_request): \OpenAPI\Client\Model\GetBidsRecommendationsResponse
```
...
try {
    $result = $apiInstance->getBidsRecommendations_3($business_id, $get_bids_recommendations_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getBidsRecommendations_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getBusinessQuarantineOffers_3()`

```php
getBusinessQuarantineOffers_3($business_id, $get_quarantine_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetQuarantineOffersResponse
```
...
try {
    $result = $apiInstance->getBusinessQuarantineOffers_3($business_id, $get_quarantine_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getBusinessQuarantineOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getBusinessSettings_3()`

```php
getBusinessSettings_3($business_id): \OpenAPI\Client\Model\GetBusinessSettingsResponse
```
...
try {
    $result = $apiInstance->getBusinessSettings_3($business_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getBusinessSettings_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignLogins_1($campaign_id): \OpenAPI\Client\Model\GetCampaignLoginsResponse
```
...
try {
    $result = $apiInstance->getCampaignLogins_1($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignLogins_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignOffers_3($campaign_id, $get_campaign_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetCampaignOffersResponse
```
...
try {
    $result = $apiInstance->getCampaignOffers_3($campaign_id, $get_campaign_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCampaignQuarantineOffers_3()`

```php
getCampaignQuarantineOffers_3($campaign_id, $get_quarantine_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetQuarantineOffersResponse
```
...
try {
    $result = $apiInstance->getCampaignQuarantineOffers_3($campaign_id, $get_quarantine_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignQuarantineOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaignRegion_3($campaign_id): \OpenAPI\Client\Model\GetCampaignRegionResponse
```
...
try {
    $result = $apiInstance->getCampaignRegion_3($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignRegion_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCampaignSettings_2()`

```php
getCampaignSettings_2($campaign_id): \OpenAPI\Client\Model\GetCampaignSettingsResponse
```
...
try {
    $result = $apiInstance->getCampaignSettings_2($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignSettings_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaign_1($campaign_id): \OpenAPI\Client\Model\GetCampaignResponse
```
...
try {
    $result = $apiInstance->getCampaign_1($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaign_1: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCampaignsByLogin_1()`

```php
getCampaignsByLogin_1($login, $page, $page_size): \OpenAPI\Client\Model\GetCampaignsResponse
```
...
try {
    $result = $apiInstance->getCampaignsByLogin_1($login, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaignsByLogin_1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCampaigns_1($page, $page_size): \OpenAPI\Client\Model\GetCampaignsResponse
```
...
try {
    $result = $apiInstance->getCampaigns_1($page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCampaigns_1: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCategoriesMaxSaleQuantum_3()`

```php
getCategoriesMaxSaleQuantum_3($get_categories_max_sale_quantum_request): \OpenAPI\Client\Model\GetCategoriesMaxSaleQuantumResponse
```
...
try {
    $result = $apiInstance->getCategoriesMaxSaleQuantum_3($get_categories_max_sale_quantum_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCategoriesMaxSaleQuantum_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCategoriesTree_3($get_categories_request): \OpenAPI\Client\Model\GetCategoriesResponse
```
...
try {
    $result = $apiInstance->getCategoriesTree_3($get_categories_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCategoriesTree_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getCategoryContentParameters_3()`

```php
getCategoryContentParameters_3($category_id): \OpenAPI\Client\Model\GetCategoryContentParametersResponse
```
...
try {
    $result = $apiInstance->getCategoryContentParameters_3($category_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getCategoryContentParameters_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getChatHistory_3($business_id, $chat_id, $get_chat_history_request, $page_token, $limit): \OpenAPI\Client\Model\GetChatHistoryResponse
```
...
try {
    $result = $apiInstance->getChatHistory_3($business_id, $chat_id, $get_chat_history_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getChatHistory_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getChats_3($business_id, $get_chats_request, $page_token, $limit): \OpenAPI\Client\Model\GetChatsResponse
```
...
try {
    $result = $apiInstance->getChats_3($business_id, $get_chats_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getChats_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getDeliveryServices_2()`

```php
getDeliveryServices_2(): \OpenAPI\Client\Model\GetDeliveryServicesResponse
```
...
try {
    $result = $apiInstance->getDeliveryServices_2();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getDeliveryServices_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeedIndexLogs_2($campaign_id, $feed_id, $limit, $published_time_from, $published_time_to, $status): \OpenAPI\Client\Model\GetFeedIndexLogsResponse
```
...
try {
    $result = $apiInstance->getFeedIndexLogs_2($campaign_id, $feed_id, $limit, $published_time_from, $published_time_to, $status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getFeedIndexLogs_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeed_2($campaign_id, $feed_id): \OpenAPI\Client\Model\GetFeedResponse
```
...
try {
    $result = $apiInstance->getFeed_2($campaign_id, $feed_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getFeed_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getFeedbackAndCommentUpdates_3()`

```php
getFeedbackAndCommentUpdates_3($campaign_id, $page_token, $limit, $from_date): \OpenAPI\Client\Model\GetFeedbackListResponse
```
...
try {
    $result = $apiInstance->getFeedbackAndCommentUpdates_3($campaign_id, $page_token, $limit, $from_date);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getFeedbackAndCommentUpdates_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeeds_2($campaign_id): \OpenAPI\Client\Model\GetFeedsResponse
```
...
try {
    $result = $apiInstance->getFeeds_2($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getFeeds_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getGoodsFeedbackComments_3()`

```php
getGoodsFeedbackComments_3($business_id, $get_goods_feedback_comments_request, $page_token, $limit): \OpenAPI\Client\Model\GetGoodsFeedbackCommentsResponse
```
...
try {
    $result = $apiInstance->getGoodsFeedbackComments_3($business_id, $get_goods_feedback_comments_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getGoodsFeedbackComments_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGoodsFeedbacks_3($business_id, $page_token, $limit, $get_goods_feedback_request): \OpenAPI\Client\Model\GetGoodsFeedbackResponse
```
...
try {
    $result = $apiInstance->getGoodsFeedbacks_3($business_id, $page_token, $limit, $get_goods_feedback_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getGoodsFeedbacks_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getGoodsStats_2($campaign_id, $get_goods_stats_request): \OpenAPI\Client\Model\GetGoodsStatsResponse
```
...
try {
    $result = $apiInstance->getGoodsStats_2($campaign_id, $get_goods_stats_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getGoodsStats_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getHiddenOffers_3($campaign_id, $offer_id, $page_token, $limit, $offset, $page, $page_size): \OpenAPI\Client\Model\GetHiddenOffersResponse
```
...
try {
    $result = $apiInstance->getHiddenOffers_3($campaign_id, $offer_id, $page_token, $limit, $offset, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getHiddenOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOfferCardsContentStatus_3()`

```php
getOfferCardsContentStatus_3($business_id, $page_token, $limit, $get_offer_cards_content_status_request): \OpenAPI\Client\Model\GetOfferCardsContentStatusResponse
```
...
try {
    $result = $apiInstance->getOfferCardsContentStatus_3($business_id, $page_token, $limit, $get_offer_cards_content_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOfferCardsContentStatus_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOfferMappingEntries_2()`

```php
getOfferMappingEntries_2($campaign_id, $offer_id, $shop_sku, $mapping_kind, $status, $availability, $category_id, $vendor, $page_token, $limit): \OpenAPI\Client\Model\GetOfferMappingEntriesResponse
```
...
try {
    $result = $apiInstance->getOfferMappingEntries_2($campaign_id, $offer_id, $shop_sku, $mapping_kind, $status, $availability, $category_id, $vendor, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOfferMappingEntries_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOfferMappings_3($business_id, $page_token, $limit, $get_offer_mappings_request): \OpenAPI\Client\Model\GetOfferMappingsResponse
```
...
try {
    $result = $apiInstance->getOfferMappings_3($business_id, $page_token, $limit, $get_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOfferMappings_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOfferRecommendations_3()`

```php
getOfferRecommendations_3($business_id, $get_offer_recommendations_request, $page_token, $limit): \OpenAPI\Client\Model\GetOfferRecommendationsResponse
```
...
try {
    $result = $apiInstance->getOfferRecommendations_3($business_id, $get_offer_recommendations_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOfferRecommendations_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOffers_2($campaign_id, $query, $feed_id, $shop_category_id, $currency, $matched, $page, $page_size): \OpenAPI\Client\Model\GetOffersResponse
```
...
try {
    $result = $apiInstance->getOffers_2($campaign_id, $query, $feed_id, $shop_category_id, $currency, $matched, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOffers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOrderBusinessBuyerInfo_3()`

```php
getOrderBusinessBuyerInfo_3($campaign_id, $order_id): \OpenAPI\Client\Model\GetBusinessBuyerInfoResponse
```
...
try {
    $result = $apiInstance->getOrderBusinessBuyerInfo_3($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrderBusinessBuyerInfo_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOrderBusinessDocumentsInfo_3()`

```php
getOrderBusinessDocumentsInfo_3($campaign_id, $order_id): \OpenAPI\Client\Model\GetBusinessDocumentsInfoResponse
```
...
try {
    $result = $apiInstance->getOrderBusinessDocumentsInfo_3($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrderBusinessDocumentsInfo_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getOrderLabelsData_2()`

```php
getOrderLabelsData_2($campaign_id, $order_id): \OpenAPI\Client\Model\GetOrderLabelsDataResponse
```
...
try {
    $result = $apiInstance->getOrderLabelsData_2($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrderLabelsData_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrder_3($campaign_id, $order_id): \OpenAPI\Client\Model\GetOrderResponse
```
...
try {
    $result = $apiInstance->getOrder_3($campaign_id, $order_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrder_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrdersStats_3($campaign_id, $page_token, $limit, $get_orders_stats_request): \OpenAPI\Client\Model\GetOrdersStatsResponse
```
...
try {
    $result = $apiInstance->getOrdersStats_3($campaign_id, $page_token, $limit, $get_orders_stats_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrdersStats_3: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getOrders_3($campaign_id, $order_ids, $status, $substatus, $from_date, $to_date, $supplier_shipment_date_from, $supplier_shipment_date_to, $updated_at_from, $updated_at_to, $dispatch_type, $fake, $has_cis, $only_waiting_for_cancellation_approve, $only_estimated_delivery, $buyer_type, $page, $page_size, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getOrders_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getPricesByOfferIds_3()`

```php
getPricesByOfferIds_3($campaign_id, $page_token, $limit, $get_prices_by_offer_ids_request): \OpenAPI\Client\Model\GetPricesByOfferIdsResponse
```
...
try {
    $result = $apiInstance->getPricesByOfferIds_3($campaign_id, $page_token, $limit, $get_prices_by_offer_ids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getPricesByOfferIds_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPrices_3($campaign_id, $page_token, $limit, $archived): \OpenAPI\Client\Model\GetPricesResponse
```
...
try {
    $result = $apiInstance->getPrices_3($campaign_id, $page_token, $limit, $archived);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getPrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPromoOffers_3($business_id, $get_promo_offers_request, $page_token, $limit): \OpenAPI\Client\Model\GetPromoOffersResponse
```
...
try {
    $result = $apiInstance->getPromoOffers_3($business_id, $get_promo_offers_request, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getPromoOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPromos_3($business_id, $get_promos_request): \OpenAPI\Client\Model\GetPromosResponse
```
...
try {
    $result = $apiInstance->getPromos_3($business_id, $get_promos_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getPromos_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getQualityRatingDetails_2()`

```php
getQualityRatingDetails_2($campaign_id): \OpenAPI\Client\Model\GetQualityRatingDetailsResponse
```
...
try {
    $result = $apiInstance->getQualityRatingDetails_2($campaign_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getQualityRatingDetails_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getQualityRatings_3($business_id, $get_quality_rating_request): \OpenAPI\Client\Model\GetQualityRatingResponse
```
...
try {
    $result = $apiInstance->getQualityRatings_3($business_id, $get_quality_rating_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getQualityRatings_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReportInfo_3($report_id): \OpenAPI\Client\Model\GetReportInfoResponse
```
...
try {
    $result = $apiInstance->getReportInfo_3($report_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getReportInfo_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getReturnApplication_2()`

```php
getReturnApplication_2($campaign_id, $order_id, $return_id): \SplFileObject
```
...
try {
    $result = $apiInstance->getReturnApplication_2($campaign_id, $order_id, $return_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getReturnApplication_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturnPhoto_2($campaign_id, $order_id, $return_id, $item_id, $image_hash): \SplFileObject
```
...
try {
    $result = $apiInstance->getReturnPhoto_2($campaign_id, $order_id, $return_id, $item_id, $image_hash);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getReturnPhoto_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturn_2($campaign_id, $order_id, $return_id): \OpenAPI\Client\Model\GetReturnResponse
```
...
try {
    $result = $apiInstance->getReturn_2($campaign_id, $order_id, $return_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getReturn_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getReturns_2($campaign_id, $page_token, $limit, $order_ids, $statuses, $type, $from_date, $to_date, $from_date2, $to_date2): \OpenAPI\Client\Model\GetReturnsResponse
```
...
try {
    $result = $apiInstance->getReturns_2($campaign_id, $page_token, $limit, $order_ids, $statuses, $type, $from_date, $to_date, $from_date2, $to_date2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getReturns_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getStocks_3($campaign_id, $page_token, $limit, $get_warehouse_stocks_request): \OpenAPI\Client\Model\GetWarehouseStocksResponse
```
...
try {
    $result = $apiInstance->getStocks_3($campaign_id, $page_token, $limit, $get_warehouse_stocks_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getStocks_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getSuggestedOfferMappingEntries_2()`

```php
getSuggestedOfferMappingEntries_2($campaign_id, $get_suggested_offer_mapping_entries_request): \OpenAPI\Client\Model\GetSuggestedOfferMappingEntriesResponse
```
...
try {
    $result = $apiInstance->getSuggestedOfferMappingEntries_2($campaign_id, $get_suggested_offer_mapping_entries_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getSuggestedOfferMappingEntries_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getSuggestedOfferMappings_3()`

```php
getSuggestedOfferMappings_3($business_id, $get_suggested_offer_mappings_request): \OpenAPI\Client\Model\GetSuggestedOfferMappingsResponse
```
...
try {
    $result = $apiInstance->getSuggestedOfferMappings_3($business_id, $get_suggested_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getSuggestedOfferMappings_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `getSuggestedPrices_2()`

```php
getSuggestedPrices_2($campaign_id, $suggest_prices_request): \OpenAPI\Client\Model\SuggestPricesResponse
```
...
try {
    $result = $apiInstance->getSuggestedPrices_2($campaign_id, $suggest_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getSuggestedPrices_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getWarehouses_2($business_id): \OpenAPI\Client\Model\GetWarehousesResponse
```
...
try {
    $result = $apiInstance->getWarehouses_2($business_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->getWarehouses_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `provideOrderItemIdentifiers_2()`

```php
provideOrderItemIdentifiers_2($campaign_id, $order_id, $provide_order_item_identifiers_request): \OpenAPI\Client\Model\ProvideOrderItemIdentifiersResponse
```
...
try {
    $result = $apiInstance->provideOrderItemIdentifiers_2($campaign_id, $order_id, $provide_order_item_identifiers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->provideOrderItemIdentifiers_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `putBidsForBusiness_3()`

```php
putBidsForBusiness_3($business_id, $put_sku_bids_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->putBidsForBusiness_3($business_id, $put_sku_bids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->putBidsForBusiness_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `putBidsForCampaign_2()`

```php
putBidsForCampaign_2($campaign_id, $put_sku_bids_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->putBidsForCampaign_2($campaign_id, $put_sku_bids_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->putBidsForCampaign_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
refreshFeed_2($campaign_id, $feed_id): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->refreshFeed_2($campaign_id, $feed_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->refreshFeed_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `searchRegionChildren_3()`

```php
searchRegionChildren_3($region_id, $page, $page_size): \OpenAPI\Client\Model\GetRegionWithChildrenResponse
```
...
try {
    $result = $apiInstance->searchRegionChildren_3($region_id, $page, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->searchRegionChildren_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
searchRegionsById_3($region_id): \OpenAPI\Client\Model\GetRegionsResponse
```
...
try {
    $result = $apiInstance->searchRegionsById_3($region_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->searchRegionsById_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `searchRegionsByName_3()`

```php
searchRegionsByName_3($name, $page_token, $limit): \OpenAPI\Client\Model\GetRegionsResponse
```
...
try {
    $result = $apiInstance->searchRegionsByName_3($name, $page_token, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->searchRegionsByName_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
sendFileToChat_3($business_id, $chat_id, $file): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->sendFileToChat_3($business_id, $chat_id, $file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->sendFileToChat_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
sendMessageToChat_3($business_id, $chat_id, $send_message_to_chat_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->sendMessageToChat_3($business_id, $chat_id, $send_message_to_chat_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->sendMessageToChat_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setFeedParams_2($campaign_id, $feed_id, $set_feed_params_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->setFeedParams_2($campaign_id, $feed_id, $set_feed_params_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->setFeedParams_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setOrderBoxLayout_1($campaign_id, $order_id, $set_order_box_layout_request): \OpenAPI\Client\Model\SetOrderBoxLayoutResponse
```
...
try {
    $result = $apiInstance->setOrderBoxLayout_1($campaign_id, $order_id, $set_order_box_layout_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->setOrderBoxLayout_1: ', $e->getMessage(), PHP_EOL;
}
```
...
## `setOrderShipmentBoxes_2()`

```php
setOrderShipmentBoxes_2($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request): \OpenAPI\Client\Model\SetOrderShipmentBoxesResponse
```
...
try {
    $result = $apiInstance->setOrderShipmentBoxes_2($campaign_id, $order_id, $shipment_id, $set_order_shipment_boxes_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->setOrderShipmentBoxes_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `skipGoodsFeedbacksReaction_3()`

```php
skipGoodsFeedbacksReaction_3($business_id, $skip_goods_feedback_reaction_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->skipGoodsFeedbacksReaction_3($business_id, $skip_goods_feedback_reaction_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->skipGoodsFeedbacksReaction_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateBusinessPrices_3()`

```php
updateBusinessPrices_3($business_id, $update_business_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateBusinessPrices_3($business_id, $update_business_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateBusinessPrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateCampaignOffers_3()`

```php
updateCampaignOffers_3($campaign_id, $update_campaign_offers_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateCampaignOffers_3($campaign_id, $update_campaign_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateCampaignOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateGoodsFeedbackComment_3()`

```php
updateGoodsFeedbackComment_3($business_id, $update_goods_feedback_comment_request): \OpenAPI\Client\Model\UpdateGoodsFeedbackCommentResponse
```
...
try {
    $result = $apiInstance->updateGoodsFeedbackComment_3($business_id, $update_goods_feedback_comment_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateGoodsFeedbackComment_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateOfferContent_3()`

```php
updateOfferContent_3($business_id, $update_offer_content_request): \OpenAPI\Client\Model\UpdateOfferContentResponse
```
...
try {
    $result = $apiInstance->updateOfferContent_3($business_id, $update_offer_content_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOfferContent_3: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateOfferMappingEntries_2()`

```php
updateOfferMappingEntries_2($campaign_id, $update_offer_mapping_entry_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateOfferMappingEntries_2($campaign_id, $update_offer_mapping_entry_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOfferMappingEntries_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateOfferMappings_3()`

```php
updateOfferMappings_3($business_id, $update_offer_mappings_request): \OpenAPI\Client\Model\UpdateOfferMappingsResponse
```
...
try {
    $result = $apiInstance->updateOfferMappings_3($business_id, $update_offer_mappings_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOfferMappings_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderItems_2($campaign_id, $order_id, $update_order_item_request)
```
...
try {
    $apiInstance->updateOrderItems_2($campaign_id, $order_id, $update_order_item_request);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOrderItems_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateOrderStatus_2($campaign_id, $order_id, $update_order_status_request): \OpenAPI\Client\Model\UpdateOrderStatusResponse
```
...
try {
    $result = $apiInstance->updateOrderStatus_2($campaign_id, $order_id, $update_order_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOrderStatus_2: ', $e->getMessage(), PHP_EOL;
}
```
...
## `updateOrderStatuses_2()`

```php
updateOrderStatuses_2($campaign_id, $update_order_statuses_request): \OpenAPI\Client\Model\UpdateOrderStatusesResponse
```
...
try {
    $result = $apiInstance->updateOrderStatuses_2($campaign_id, $update_order_statuses_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateOrderStatuses_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updatePrices_3($campaign_id, $update_prices_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updatePrices_3($campaign_id, $update_prices_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updatePrices_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updatePromoOffers_3($business_id, $update_promo_offers_request): \OpenAPI\Client\Model\UpdatePromoOffersResponse
```
...
try {
    $result = $apiInstance->updatePromoOffers_3($business_id, $update_promo_offers_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updatePromoOffers_3: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateStocks_2($campaign_id, $update_stocks_request): \OpenAPI\Client\Model\EmptyApiResponse
```
...
try {
    $result = $apiInstance->updateStocks_2($campaign_id, $update_stocks_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->updateStocks_2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
verifyOrderEac_0($campaign_id, $order_id, $verify_order_eac_request): \OpenAPI\Client\Model\VerifyOrderEacResponse
```
...
try {
    $result = $apiInstance->verifyOrderEac_0($campaign_id, $order_id, $verify_order_eac_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExpressApi->verifyOrderEac_0: ', $e->getMessage(), PHP_EOL;
}
```
